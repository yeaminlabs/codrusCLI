...
from codrus_cli.tools.display import (
...
from codrus_cli.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `codrus_cli.soul.approval.Request`, but
