...
from codrus_cli.soul.agent import load_agents_md
from codrus_cli.soul.context import Context
from codrus_cli.soul.dynamic_injections.afk_mode import AFK_DISABLED_REMINDER
from codrus_cli.soul.message import system, system_reminder
from codrus_cli.utils.export import is_sensitive_file
from codrus_cli.utils.path import sanitize_cli_path, shorten_home
from codrus_cli.utils.slashcmd import SlashCommandRegistry
...
async def add_dir(soul: CodrusSoul, args: str):
    ...
    from codrus_cli.utils.path import is_within_directory, list_directory
