...
from codrus_cli.soul import StatusSnapshot, format_context_status
from codrus_cli.ui.shell import placeholders as prompt_placeholders
...
from codrus_cli.ui.theme import get_prompt_style, get_toolbar_colors
from codrus_cli.utils.clipboard import (
...
from codrus_cli.wire.types import ContentPart
...
class LocalFileMentionCompleter(Completer):
    ...
    :mod:`codrus_cli.utils.file_filter` so that the web backend can reuse
    them.
    """
    ...
    def _get_top_level_paths(self) -> list[str]:
        from codrus_cli.utils.file_filter import is_ignored
...
class CustomPromptSession:
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from codrus_cli.utils.editor import edit_text_in_editor, get_editor_command
