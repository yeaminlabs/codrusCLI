...
from codrus_cli.utils.datetime import format_duration
...
async def usage(app: Shell, args: str):
    ...
    if usage_url is None:
        console.print("[yellow]Usage is available on Codrus Code platform only.[/yellow]")
        return
    ...
    with console.status("[cyan]Fetching usage...[/cyan]"):
        ...
        try:
            ...
            if e.status == 401:
                ...
                message = "Usage endpoint not available. Try Codrus for Coding."
