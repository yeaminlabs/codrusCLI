...
from codrus_cli.soul import get_wire_or_none, wire_send
from codrus_cli.soul.toolset import get_current_tool_call_or_none
from codrus_cli.tools.utils import ToolRejectedError, load_desc
...
class ExitPlanMode(CallableTool2[Params]):
    ...
    def bind(
        ...
        """Late-bind soul callbacks after CodrusSoul is constructed."""
