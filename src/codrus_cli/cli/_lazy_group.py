...
class LazySubcommandGroup(typer.core.TyperGroup):
    ...
    lazy_subcommands: dict[str, tuple[str, str, str]] = {
        "info": ("codrus_cli.cli.info", "cli", "Show version and protocol information."),
        "export": ("codrus_cli.cli.export", "cli", "Export session data."),
        "mcp": ("codrus_cli.cli.mcp", "cli", "Manage MCP server configurations."),
        "plugin": ("codrus_cli.cli.plugin", "cli", "Manage plugins."),
        "vis": ("codrus_cli.cli.vis", "cli", "Run Codrus Agent Tracing Visualizer."),
        "web": ("codrus_cli.cli.web", "cli", "Run CodrusCLI powered by Codrus models web interface."),
    }
