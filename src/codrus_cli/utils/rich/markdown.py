...
from codrus_cli.utils.rich.syntax import KIMI_ANSI_THEME_NAME, resolve_code_theme
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "codrus-ansi".
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help='code theme (pygments name or "codrus-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
