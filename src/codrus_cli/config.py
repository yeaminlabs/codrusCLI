...
from codrus_cli.llm import ModelCapability, ProviderType
...
class Config(BaseModel):
    ...
    merge_all_available_skills: bool = Field(
        default=True,
        description=(
            "Merge skills from all existing brand directories (codrus/claude/codex) "
    ...
    telemetry: bool = Field(
        default=True,
        description="Enable anonymous telemetry to help improve codrus-cli. Set to false to disable.",
    )
