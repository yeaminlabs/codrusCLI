"""
Telemetry event tracking for codrus-cli.

This module has NO dependencies on other codrus_cli modules to avoid import cycles.
...
Usage:
    from codrus_cli.telemetry import track, set_context, attach_sink
